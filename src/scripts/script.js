...
const positions = [];
      ...
      positions['Воронежская область']                      = ['30.60%','59.29%'];
      positions['Курская область']                          = ['23.38%','58.24%'];
      positions['Белгородская область']                     = ['21.52%','62.96%'];
      positions['Орловская область']                        = ['20.70%','53.52%'];
      positions['Брянская область']                         = ['13.55%','50.47%'];
      positions['Смоленская область']                       = ['16.46%','46.07%'];
      positions['Калининградская область']                  = ['5.88%','41.66%'];
      positions['Псковская область']                        = ['16.08%','35.47%'];
      positions['Ленинградская область']                    = ['7.89%','34.52%'];
      positions['Новгородская область']                     = ['19.21%','31.69%'];
      positions['Тверская область']                         = ['24.72%','37.57%'];
      positions['Карелия']                                  = ['20.40%','25.60%'];
      positions['Мурманская область']                       = ['18.17%','17.31%'];
      positions['Архангельская область']                    = ['26.58%','22.04%'];
      positions['Московкая область']                        = ['26.36%','43.86%'];
      ...
      positions['Республика Татарстан']                     = ['56.59%','41.34%'];
      positions['Ульяновская область']                      = ['46.02%','46.17%'];
      positions['Самарская область']                        = ['48.32%','49.84%'];
      positions['Чувашская область']                        = ['41.92%','42.81%'];
      ...
      positions['Владимирская область']                     = ['33.36%','41.76%'];
      positions['Рязанская область']                        = ['33.21%','45.44%'];
...
document.addEventListener("DOMContentLoaded", function() {
    let regionsForMap = [];
    // смерджим входной объект (regionsData) с данными по позициям регионов(positions), которые собраны нами вручную
...
class SearchRegion {
    ...
    static findRegions( searchInput ) {
        let regions = document.querySelectorAll(".region-cell__name");
